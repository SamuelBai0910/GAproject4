    ...
    return (
      <div>
        <div className="form-container">
          <form autoComplete="off" onSubmit={this.handleSubmit} className='signup'>
            <h1>SignUp</h1>
            <input type="text" name="name" value={this.state.name} placeholder='username' onChange={this.handleChange} required />
            ...
            <input type="password" name="confirm" value={this.state.confirm} placeholder='password confirm' onChange={this.handleChange} required />
